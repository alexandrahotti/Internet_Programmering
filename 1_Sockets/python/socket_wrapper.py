class SocketWrapper:
    """
    Wraps Python sockets to make communication a little bit nicer.
    Loosely based of code from https://docs.python.org/3.7/howto/sockets.html
    Author: Alexander Viklund (viklu@kth.se)
    """
